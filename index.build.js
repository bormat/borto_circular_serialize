...
/***/ function(module, exports, __webpack_require__) {
	...
	window.serializeObj = _index.serializeObj;
	window.parseStr = _index.parseStr;
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	var MyArray = __webpack_require__(2).default;
	
	/*****************************************************************************************/
	/***********Convert object into String, non enumerable properties are ignored ************/
	/*****************************************************************************************/
	var serializeObj = function serializeObj(theMainObject) {
	  ...
	  */
			calcultateNbOjectNotInTab: function calcultateNbOjectNotInTab() {
	  ...
	  */
			link: function link(ref, alreadyLinked) {
	 ...
	 */
		function createStringArray(obj) {
			...
			if (obj.length) {
				// usefull for fake array that extend Array
	...
	var parseStr = function parseStr(str, prototypes) {
		var allObj;
		//function principal
		function parse(str) {
